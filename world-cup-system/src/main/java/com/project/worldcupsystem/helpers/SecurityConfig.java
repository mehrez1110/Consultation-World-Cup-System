...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
       ...
       //////////////////////////// this part is for mapping endpoint to roles ///////////////////////////////
                ...
                http.authorizeRequests().antMatchers(HttpMethod.POST,"/api/matches").hasAuthority("MANAGER");
        http.authorizeRequests().antMatchers(HttpMethod.PUT,"/api/matches").hasAuthority("MANAGER");
