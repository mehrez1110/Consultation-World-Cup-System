...
class MatchTicketsView extends StatefulWidget {
  const MatchTicketsView({Key? key}) : super(key: key);

  @override
  State<MatchTicketsView> createState() => _MatchTicketsViewState();
}

class _MatchTicketsViewState extends MomentumState<MatchTicketsView> {
